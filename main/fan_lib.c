...
void set_motor_speed(int gpio1, int gpio2, int state) {
    ...
    switch(state) {
        case 0:
            ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, DUTY_OFF);
            ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0);
            gpio_set_level(gpio2, 0);
            break;
        case 1:
            ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, DUTY_LIGHT);
            ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0);
            gpio_set_level(gpio2, 1);
            break;
        case 2:
            ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, DUTY_MEDIUM);
            ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0);
            gpio_set_level(gpio2, 1);
            break;
        case 3:
            ledc_set_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0, DUTY_HIGH);
            ledc_update_duty(LEDC_HIGH_SPEED_MODE, LEDC_CHANNEL_0);
            gpio_set_level(gpio2, 1);
            break;
        }
